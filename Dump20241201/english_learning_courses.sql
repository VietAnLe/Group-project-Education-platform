...
INSERT INTO `courses` VALUES (1,'english-basic (for kids)','learn basic english for children-level',NULL),(2,'english-high school','provide High School students with the English skills they will need ',NULL),(3,'IELT (LIS + READ)','doing exercises about IELTS\'s reading and listening for praticing  ',NULL);
